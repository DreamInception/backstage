    ...
    var resourceAudio = new Vue({
        ...
        methods: {
            addDtl: function () {
                ...
                $.ajax({
                    ...
                    if (result.result == 0) {
                        ...
                        vm.realdoc = vm.resocdtl.realdoc;
                        vm.exampledoc = vm.resocdtl.exampledoc;
                        ...
                        if(vm.resocdtl.filePath!=undefined){
                        	preview.init(vm.resocdtl.realextension,vm.resocdtl.filePath,'audioA');
                        }
            ...
            changeDtlRec1: function () {
                ...
                preview.init(realextension,filePath,'audioA');
                }
            },
            changeDtlRec2: function () {
                ...
                preview.init('swf',examplePath,'audioB');
                }
            },
            ...
            winboxOffic:function(){
                $(".winboxOffic").css("display","block");
            },
            winboxGalley:function(){
                $(".winboxGalley").css("display","block");
            },
            winboxWjA:function(){
...
//
            ...
            commentlist: function () {
                ...
                $.ajax({
                    ...
                    vm.cur1 = data.cur_page;
                    vm.all1 = data.page_count;
                    vm.total_count1 = data.total_count;
                    vm.commentList = data.rows
                })
            },
            buylist: function () {
                var vm = this;
