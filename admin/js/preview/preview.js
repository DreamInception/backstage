...
preview.previewAudio = function(fileurl,clazz) {
    ...
    $('#'+clazz).html('');
    var url = fileurl;
    $f(clazz, "../admin/js/preview/flowplayer-3.2.16.swf", {
        clip: {	url: url, provider: "audio",coverImage: { url: "../admin/js/preview/images/2.png",
            scaling: 'orig' }},
        plugins: {
            audio:{
                url: "../admin/js/preview/flowplayer.audio-3.2.11_0.swf"
            },
            controls:{
                autoHide:false
            }
...
preview.previewFlv = function(fileurl,clazz) {
	...
	$f(clazz, "../admin/js/preview/flowplayer-3.2.16.swf", {
		...
		plugins: {
			controls: {
				autoHide: false,
				url: "../admin/js/preview/flowplayer.controls-3.2.15.swf"
			}
		}
	});
}
...
preview.previewOffice = function(url,clazz) {
	jQuery("#"+clazz).css("height", "450px");
	jQuery("#"+clazz).css("width", "600px");
	var fp = new FlexPaperViewer(
			'../admin/js/preview/FlexPaperViewer.swf',
			clazz, 
			{
				config : {
					SwfFile : url,
...
preview.previewFlash = function(url,clazz) {
	...
	swfobject.embedSWF(
					...
					"410",
					"9.0.0",
					"../admin/js/preview/expressInstall.swf",
